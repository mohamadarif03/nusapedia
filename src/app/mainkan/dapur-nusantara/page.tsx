...
export default function CookingGamePage() {
  ...
  return (
    <div className="min-h-screen bg-[#3e2723] dark:bg-[#1a0c08] text-white pt-24 pb-20 relative overflow-hidden transition-colors duration-500">
      
      {/* Background woven bamboo overlay wrapper */}
